...
PILOT_PID_FILE := $(UI_PID_FILE)
PILOT_LOG_FILE := $(UI_LOG_FILE)
...
help:
	...
	@echo "  make ui-clean         Remove UI dist"
	@echo "  make ui-server        Run UI server in foreground"
	@echo "  make ui-run           Build UI + run server"
	...
	@echo "  make ui-clean-all     Remove UI dist and ui pid/log"
	@echo
	@echo "Pilot (deprecated aliases):"
	@echo "  make pilot-ui-install (alias for ui-install)"
	@echo "  make pilot-ui-build   (alias for ui-build)"
	@echo "  make pilot-ui-dev     (alias for ui-dev)"
	@echo "  make pilot-ui-clean   (alias for ui-clean)"
	@echo "  make pilot-server     (alias for ui-server)"
	@echo "  make pilot-run        (alias for ui-run)"
	@echo "  make pilot-up         (alias for ui-up)"
	@echo "  make pilot-down       (alias for ui-down)"
	@echo "  make pilot-status     (alias for ui-status)"
	@echo "  make pilot-logs       (alias for ui-logs)"
	@echo "  make pilot-clean      (alias for ui-clean-all)"
	@echo
	@echo "Cleanup:"
...
pilot-ui-install: ui-install

.PHONY: pilot-ui-build
pilot-ui-build: ui-build

.PHONY: pilot-ui-dev
pilot-ui-dev: ui-dev

.PHONY: pilot-ui-clean
pilot-ui-clean: ui-clean

.PHONY: pilot-server
pilot-server: ui-server
...
.PHONY: pilot-status
pilot-status: ui-status

.PHONY: pilot-logs
pilot-logs: ui-logs

.PHONY: pilot-clean
pilot-clean: ui-clean-all
