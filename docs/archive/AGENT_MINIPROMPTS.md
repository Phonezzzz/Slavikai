...
- Проект: Python 3.12, архитектура Agent/Planner/Executor/Tools/Memory/VectorIndex/Workspace.
...
- Если остаётся single‑file: обнови документацию и тесты так, чтобы это было очевидно.
**Критерии готовности:**
...
- Улучшить вывод: всегда возвращать `stdout/stderr/exit_code`, уже реализовано — убедиться, что формат корректно отражается.
**Критерии готовности:**
