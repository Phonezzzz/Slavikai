...
- Никаких новых фич вокруг DualBrain.
...
### M3 — Удаление DualBrain
- После подтверждения устойчивого M2‑цикла.
- Чистка dual/critic из кода/доков/тестов.
- **DoD:** ни одного упоминания dual/critic, все проверки зелёные.
