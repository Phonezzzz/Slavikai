...
_agent_scope = runtime_contract._agent_scope
...
_selected_model_snapshot = runtime_contract._selected_model_snapshot
_sync_session_runtime_override = runtime_contract._sync_session_runtime_override
...
MODEL_CONFIG_PATH: Final[Path] = _ui_settings.MODEL_CONFIG_PATH
...
APPEARANCE_THEMES: Final[set[str]] = _ui_settings.APPEARANCE_THEMES
DEFAULT_APPEARANCE_THEME: Final[str] = _ui_settings.DEFAULT_APPEARANCE_THEME
...
_SETTINGS_RUNTIME = settings_runtime.SettingsRuntimeBindings(
    ...
    model_config_path_getter=lambda: MODEL_CONFIG_PATH,
...
_load_appearance_settings = _SETTINGS_RUNTIME.load_appearance_settings
_save_appearance_settings = _SETTINGS_RUNTIME.save_appearance_settings
...
_load_default_model = _SETTINGS_RUNTIME.load_default_model
_save_default_model = _SETTINGS_RUNTIME.save_default_model
