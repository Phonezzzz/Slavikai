      ...
      <div className="min-h-0 flex-1 overflow-y-auto" data-scrollbar="auto">
        {displayMessages.length === 0 ? (
          ...
          <div className="max-w-5xl mx-auto px-6 py-6 space-y-8">
            ...
            {sending && !streamingAssistantMessage ? (
              <div className="flex gap-3">
                ...
                <div className="flex-1 min-w-0">
                  <div className="inline-flex items-center gap-2 rounded-lg border border-zinc-800 bg-zinc-900/60 px-3 py-2 text-sm text-zinc-400">
                    <LoaderCircle className="h-4 w-4 animate-spin" />
                    <span>
                      {runtimeMode === 'auto' || runtimeMode === 'act'
                        ? 'Agent is working…'
                        : 'SlavikAI is thinking…'}
                    </span>
                  </div>
                </div>
              </div>
